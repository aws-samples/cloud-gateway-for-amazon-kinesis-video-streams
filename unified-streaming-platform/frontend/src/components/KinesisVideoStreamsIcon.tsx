...
interface KinesisVideoStreamsIconProps {
  size?: number;
}

const KinesisVideoStreamsIcon: React.FC<KinesisVideoStreamsIconProps> = ({ 
  size = 32
}) => {
  return (
    <svg 
    ...
    >
      <defs>
        <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id={`linearGradient-kvs-${size}`}>
          <stop stopColor="#4D27A8" offset="0%"></stop>
          <stop stopColor="#A166FF" offset="100%"></stop>
        </linearGradient>
      </defs>
      <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g fill={`url(#linearGradient-kvs-${size})`}>
...
export default KinesisVideoStreamsIcon;
